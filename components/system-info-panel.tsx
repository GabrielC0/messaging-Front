...
export function SystemInfoPanel() {
  ...
  useEffect(() => {
    ...
    // Récupérer les informations de build depuis les variables d'environnement
    setBuildInfo({
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Informations Système - WhatsApp Clone
          </DialogTitle>
        </DialogHeader>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Connexion Backend</span>
                {getConnectionBadge()}
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="space-y-1">
                <span className="text-sm text-muted-foreground">URL GraphQL</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Intervalle de reconnexion</span>
                <Badge variant="outline">{apolloConfig.RECONNECT_INTERVAL / 1000}s</Badge>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">État de connexion</span>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">              <div className="space-y-2">
                ...
                <div className="pl-6 space-y-1">
                  <div className="text-sm text-muted-foreground">PostgreSQL sur Render.com ✅</div>
                  <div className="text-xs text-muted-foreground">
                    Hébergeur: dpg-d17tma3uibrs7384okvg-a.oregon-postgres.render.com
                  </div>
                  <div className="text-xs text-muted-foreground">
              ...
              <div className="space-y-2">
                ...
                <div className="pl-6 space-y-1">
                  <div className="text-sm text-muted-foreground">Redis sur Upstash.io ✅</div>
                  <div className="text-xs text-muted-foreground">
                ...
                <div className="pl-6 space-y-1">
                  <div className="text-sm text-muted-foreground">NestJS sur Render.com</div>
                  <div className="text-xs text-muted-foreground">
                    GraphQL + REST API
                  </div>
                  ...
                  <Badge 
                    variant={connectionInfo.isAvailable ? "outline" : "destructive"} 
                    className={`text-xs ${connectionInfo.isAvailable 
                      ? "bg-green-50 text-green-600 border-green-200" 
                      : "bg-red-50 text-red-600 border-red-200"
                    }`}
                  >
                    {connectionInfo.isAvailable ? "✅ Connecté" : "❌ Déconnecté"}
                  </Badge>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Mode de cache</span>
                <Badge variant="outline">
                  {connectionInfo.isProduction ? "Cache-first" : "Cache-and-network"}
                </Badge>
              </div>
              
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">DevTools</span>
                <Badge variant={connectionInfo.isProduction ? "destructive" : "default"}>
              ...
              <div className="flex justify-between items-center">
                ...
                <Badge variant={connectionInfo.isProduction ? "default" : "secondary"}>
        ...
        <div className="mt-6 p-4 bg-muted rounded-lg">
          <h4 className="font-medium text-sm mb-2">🚀 Configuration Cloud Active</h4>
          <p className="text-xs text-muted-foreground">
            Votre application est maintenant configurée pour utiliser l'infrastructure cloud avec PostgreSQL et Redis hébergés. 
            Plus besoin de base de données locale ! 
